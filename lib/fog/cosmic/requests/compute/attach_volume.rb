  ...
  module Cosmic
    class Compute
      ...
      class Real
        ...
        #
        # {Cosmic API Reference}[https://apidoc.mcc.schubergphilis.com/root_admin/attachVolume.html]
      ...
      class Mock
        ...
        def attach_volume(options={})
          ...
          unless volume
            raise Fog::Cosmic::Compute::BadRequest.new("Unable to execute API command attachvolume due to invalid value. Object volumes(uuid: #{volume_id}) does not exist.")
          end

          server = self.data[:servers][server_id]
          unless server
            raise Fog::Cosmic::Compute::BadRequest.new("Unable to execute API command attachvolume due to invalid value. Object vm_instance(uuid: #{server_id}) does not exist.")
          end
